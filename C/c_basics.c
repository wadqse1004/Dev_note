...
이 파일은 C언어의 기본적인 문법을 정리한 스크립트입니다.
C 코드는 'main' 함수 내에서 실행되므로, 각 예제는 main 함수 안에
배치되어 있습니다. 컴파일 후 실행하여 결과를 확인할 수 있습니다.

컴파일 및 실행 (예: gcc 사용 시):
1. 컴파일: gcc c_basics.c -o c_basics
2. 실행: ./c_basics (Windows의 경우 c_basics.exe)
*/
